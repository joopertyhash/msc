...
_regex = {
            'chat_id' : r'chat_id',
    'restdb' : r'restdb.io',
    'quiknode.pro api key' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+quiknode.pro/\w{40}', #quiknode.pro
    'chatId' : r'chatId',
    'x-apikey' : r'x-apikey',
    #'nodereal.io' : r'nodereal.io',
    'api.telegram.org' : r'api.telegram.org/bot',
    #'org/bot' : r'org/bot',
    'rpcfast.com api key' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+.rpcfast.com\?api_key=\w{64}',
    'infura.io api key' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+infura.io/v3/\w{32}',
    #'pokt.network' : r'pokt.network',
    'blockvision.org' : r'blockvision.org',
    'pro-openapi.debank.com' : r'pro-openapi.debank.com',
    'getblock.io' : r'bsc.getblock.io/mainnet',
    '^([a-z]+\s){11}[a-z]+$'
    'nodereal.io api key' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+nodereal.io/v1/\w{32}',
    'pokt1' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+gateway.pokt.network/v1/\w{24}',    
    'pokt2' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+gateway.pokt.network/v1/lb/\w{24}', 
    'ankr' : r'https?://rpc.ankr.com/\w{3,10}/\w{64}', 
    'moralis' : r'speedy-nodes-nyc.moralis.io/', 
    'alchemyapi.io api' : r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+alchemyapi.io/v2/\w{32}',
    'privatekey': r'privatekey([13][a-km-zA-HJ-NP-Z1-9]{25,34})',
    'publickey': r'publickey([13][a-km-zA-HJ-NP-Z1-9]{25,34})',
    'seedphrase': r'seedphrase(\b[a-z]{12}\b)',
    '\b([1-9A-HJ-NP-Za-km-z]{32,34}|[1-9A-HJ-NP-Za-km-z]{64})\b' : r'\b([1-9A-HJ-NP-Za-km-z]{32,34}|[1-9A-HJ-NP-Za-km-z]{64})\b',
    '\/balances\?account=' : r'\/balances\?account=',
    '/^\s*bot\s*[\d\w]+:[\d\w_-]+\s*$/gm' : r'/^\s*bot\s*[\d\w]+:[\d\w_-]+\s*$/gm'
    #'apple-touch-icon' : r'apple-touch-icon',
    #'datafeedSupportedResolutions' : r'datafeedSupportedResolutions',
    'restdb\.io'
    '^.*(privatekey).*$'
    '/privatekey[^\s]*replit\.com/'
